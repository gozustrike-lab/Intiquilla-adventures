...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* ── MOBILE RTL DRAWER ── */}
      <div
        className={`fixed top-0 right-0 h-screen w-[85vw] max-w-[380px] bg-[#0B1311]/98 backdrop-blur-xl border-l border-[#D4AF37]/15 z-[70] flex flex-col transform transition-transform duration-[350ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:hidden overflow-hidden ${
